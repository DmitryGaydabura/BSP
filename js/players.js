...
/** Uniform results view: tournament wins and history rows open the same
    finished-tournament detail page as the Турніри tab (the legacy 3D
    trophy modal was removed). Modals sit above #t-page — close them first. */
